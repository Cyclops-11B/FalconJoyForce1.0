...
static const double VEL_SENSITIVITY = 6.5; // Higher means more stick travel per handle travel
static const double VEL_DEADZONE = 0.0004; // Set lower to eliminate noise and small movements
static const double VEL_CURVE = 0.55; // less than 1.0 boosts small motions; 1.0 = linear
...
static const double PUSH_SPEED_MAX = 2.0; // maximum push speed at full tilt
...
static const double RECOIL_AIM_DAMP = 0.7;  // stick sensitivity multiplier during recoil (0=frozen, 1=no effect)
...
static const DWORD  IMPULSE_GAP_MS = 45;
...
const double AxisState::VEL_ALPHA = 0.35;
